...
-(void)initialisePlot
{
   ...
   if ( (self.hostingView == nil) || (self.graphData == nil) ) {
      NSLog(@"SCBScatterPlot: Cannot initialise plot without hosting view or data.");
      return;
   }
   
   if ( self.graph != nil ) {
      NSLog(@"SCBScatterPlot: Graph object already exists.");
      return;
   }
   ...
   self.graph.plotAreaFrame.paddingLeft = 80.0f;
